...
class CouplingSolidShellAnalysisStage(StructuralMechanicsAnalysis):
    def __init__(self, model, queso_settings, kratos_settings_filename, elements, boundary_conditions):
        ...
        IgaModelPart.AddNodalSolutionStepVariable(KM.ROTATION)
        IgaModelPart.AddNodalSolutionStepVariable(KM.REACTION_MOMENT)
    ...
    def ModifyInitialGeometry(self):
        ...
        KM.VariableUtils().AddDof(KM.ROTATION_X, KM.REACTION_MOMENT_X, IgaModelPart)
        KM.VariableUtils().AddDof(KM.ROTATION_Y, KM.REACTION_MOMENT_Y, IgaModelPart)
